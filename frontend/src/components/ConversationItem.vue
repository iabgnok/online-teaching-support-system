        ...
        >
          ...
          <div class="tg-menu-list">
            ...
            <div 
              ...
              @mouseenter="showFolderSubmenu = true"
              @mouseleave="showFolderSubmenu = false"
            >
              ...
              <transition name="submenu-fade">
                <div v-if="showFolderSubmenu" class="tg-submenu-panel" @click.stop>
                  <div 
...
const addToFolderDirect = (folderId) => {
  emit('add-to-folder', props.conversation.id, folderId)
  hideContextMenu()
}
